...
### 🧑‍💻 About Me
- 🎯 Specializing in **TypeScript** and **React JS** for modern frontend development
- 🛠️ Also experienced with **Laravel** for backend & fullstack projects
- 🔭 Currently building **LMS-Univ**, a Laravel-based academic information system
- 💬 Ask me about **React**, **TypeScript**, **Laravel**, or **web development**
...
### 🚀 Sekilas Proyek
- **LMS-Univ** — Sistem informasi akademik berbasis Laravel untuk manajemen kampus/universitas.
- **TypeScript-Temp** — Eksperimen dan latihan project menggunakan TypeScript.
- **Resident-Evil-Web** — Website bertema Resident Evil, dibangun dengan HTML/CSS/JS.
...
![Profile Views](https://komarev.com/ghpvc/?username=Aeng21&color=4ADE80&style=flat)
